...
struct SpaceMixieChat {
  ...
  int sel_message_index = -1; /* -1 = no selection */
  int sel_start = 0;          /* Character offset start */
  int sel_end = 0;            /* Character offset end */
  char _pad1[4] = {};
...
struct SpaceTextureSets {
  ...
  int active_texture_set_index = 0;
  char _pad[4] = {};
};
